...
clean_text <- function(institute) {
  ...
  institute$Text = str_replace_all(institute$Text, "[^abcdefghijklmnopqrstuvwxyzABCDEFHIJKLMNOPQRSTUVWXZ0123456789 ]", " ")
...
k = lda_model$get_top_words(n = 20, topic_number = 1:topics, lambda = 1)
k = k[, j]
