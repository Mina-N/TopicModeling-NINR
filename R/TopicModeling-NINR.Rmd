...
#ninr = read_excel("./../data/NINR-2015-all-apps-with-RCDC.xlsx", guess_max = 1000000)
awardedNINR19 = read_excel("./../data/awarded-grants-NINR-2019.xlsx", guess_max = 1000000)
not_awardedNINR19 = read_excel("./../data/not-awarded-grants-NINR-2019.xlsx", guess_max = 1000000)

#ninr <- rbind(awardedNINR19, not_awardedNINR19)
#rm(awardedNINR19)
#rm(not_awardedNINR19)
```

## Rename Columns
```{r}
names(awardedNINR19 )[names(awardedNINR19 ) == 'PI Name'] <- 'PI.Name'
names(awardedNINR19 )[names(awardedNINR19 ) == 'PO Name'] <- 'PO.Name'
names(awardedNINR19 )[names(awardedNINR19 ) == 'RFA/PA Number'] <- 'RFA.PA.Number'                                                                                  
names(awardedNINR19 )[names(awardedNINR19 ) == 'Stat Desc'] <- 'Stat.Desc'                                                                                          
names(awardedNINR19 )[names(awardedNINR19 ) == 'Abstract Text (only)'] <- 'Abstract' 

names(not_awardedNINR19)[names(not_awardedNINR19) == 'PI Name'] <- 'PI.Name'
names(not_awardedNINR19)[names(not_awardedNINR19) == 'PO Name'] <- 'PO.Name'
names(not_awardedNINR19)[names(not_awardedNINR19) == 'RFA/PA Number'] <- 'RFA.PA.Number'                                                                                  
names(not_awardedNINR19)[names(not_awardedNINR19) == 'Stat Desc'] <- 'Stat.Desc'                                                                                          
names(not_awardedNINR19)[names(not_awardedNINR19) == 'Abstract Text (only)'] <- 'Abstract' 
```
...
awardedNINR19 <- awardedNINR19[awardedNINR19$Abstract != "-",]
...
awardedNINR19 = select(awardedNINR19, -c("Title", "Abstract", "SA Text"))
awardedNINR19 = mutate(awardedNINR19, Text = ifelse(is.na(Text), "", Text))
awardedNINR19 = mutate(awardedNINR19, Text = ifelse(grepl("the first study", Text, fixed = TRUE), Text, ""))
...
text = c("Title", "Abstract", "SA Text")
not_awardedNINR19 <- not_awardedNINR19[not_awardedNINR19$Abstract != "-",]
not_awardedNINR19$Text <- not_awardedNINR19[[text[1]]]

if(length(text) > 1){
  for(i in 2:length(text)){
    not_awardedNINR19$Text <- paste(not_awardedNINR19$Text, not_awardedNINR19[[text[i]]])
    print(i)
  }
}
print(substr(not_awardedNINR19[1, "Text"], 1000, 11000))

not_awardedNINR19 = select(not_awardedNINR19, -c("Title", "Abstract", "SA Text"))
not_awardedNINR19 = mutate(not_awardedNINR19, Text = ifelse(is.na(Text), "", Text))
not_awardedNINR19 = mutate(not_awardedNINR19, Text = ifelse(grepl("the first study", Text, fixed = TRUE), Text, ""))
not_awardedNINR19 = filter(not_awardedNINR19, Text != "")
...
### Clean Up Text for Awarded Text
...
### Clean Up Text for Not Awarded Text
```{r}
# Remove weird characters
not_awardedNINR19$Text = str_replace_all(not_awardedNINR19$Text, "\n", " ")
not_awardedNINR19$Text = str_replace_all(not_awardedNINR19$Text, "\r", " ")
not_awardedNINR19$Text = str_replace_all(not_awardedNINR19$Text, "'", "")
not_awardedNINR19$Text = str_replace_all(not_awardedNINR19$Text, "-", " ")

# Replace non-alpha numeric characters with a space
not_awardedNINR19$Text = str_replace_all(not_awardedNINR19$Text, "[^abcdefghijklmnopqrstuvwxyzABCDEFHIJKLMNOPQRSTUVWXZ0123456789 ]", " ")

# Put everything in lowercase
not_awardedNINR19$Text = tolower(not_awardedNINR19$Text)

# Remove a few select words and extra spaces
not_awardedNINR19$Text = str_replace_all(not_awardedNINR19$Text, "abstract", " ")
not_awardedNINR19$Text = str_replace_all(not_awardedNINR19$Text, "project", " ")
not_awardedNINR19$Text = str_replace_all(not_awardedNINR19$Text, "proposal", " ")
not_awardedNINR19$Text = str_replace_all(not_awardedNINR19$Text, "summary", " ")
not_awardedNINR19$Text = str_replace_all(not_awardedNINR19$Text, "narrative", " ")
not_awardedNINR19$Text = str_replace_all(not_awardedNINR19$Text, "background", " ")
not_awardedNINR19$Text = str_replace_all(not_awardedNINR19$Text, "supplement", " ")
not_awardedNINR19$Text = str_replace_all(not_awardedNINR19$Text, "significance", " ")
not_awardedNINR19$Text = str_replace_all(not_awardedNINR19$Text, "overall", " ")
not_awardedNINR19$Text = str_replace_all(not_awardedNINR19$Text, "title", " ")
not_awardedNINR19$Text = str_replace_all(not_awardedNINR19$Text, "specific aims", " ")
not_awardedNINR19$Text = str_replace_all(not_awardedNINR19$Text, "goal", " ")
not_awardedNINR19$Text = str_replace_all(not_awardedNINR19$Text, "research plan", " ")
not_awardedNINR19$Text = str_replace_all(not_awardedNINR19$Text, "overview", " ")
not_awardedNINR19$Text = str_replace_all(not_awardedNINR19$Text, "\\s+", " ")
not_awardedNINR19$Text = str_replace_all(not_awardedNINR19$Text, "description provided by applicant", " ")

not_awardedNINR19$Text = str_trim(not_awardedNINR19$Text, side = "both")
...
```{r}
awardedNINR19 <- awardedNINR19[!duplicated(awardedNINR19[ , c("Text")]),]
nrow(awardedNINR19)

not_awardedNINR19 <- not_awardedNINR19[!duplicated(not_awardedNINR19[ , c("Text")]),]
nrow(not_awardedNINR19)
...
```{r}
setDT(not_awardedNINR19)
setkey(not_awardedNINR19, Project)
```
...
it = itoken(not_awardedNINR19$Text,
            #tokenizer = word_tokenizer, 
            tokenizer = stem_tokenizer,
            ids = not_awardedNINR19$Project, 
            progressbar = FALSE)
...
```{r}
 ...
 pp
 write_csv(pp, "LDA_Opt_Param_not_awardedNINR19_novelStudy.csv")
```

Let's load the optimal parameters.
```{r}
pp = read_csv("LDA_Opt_Param_not_awardedNINR19_novelStudy.csv")
pp = data.frame(pp)
...
write_csv(p2, "NINR-noSA-2015-topics.csv")
```
