...
ninr_2 = read_excel("./../data/NICHD_Translational.xlsx", guess_max = 1000000)
...
```{r}
pp_ninr = read_csv("LDA_Opt_Param_NINR_NIDDK_Prevention.csv")
...
write_csv(p2, "NINR-NICHD-topics.csv")
```
