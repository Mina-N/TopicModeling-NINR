...
nih1 = read_csv("Bioinformatics_Meta_Data_2009+.csv", guess_max = 1000000)
nih1 = (
  nih1 %>% mutate(PAC = substr(PCC, 1, 4),
                  PO = substr(PCC, 5, 6))
)

nih2 = read_csv("Bioinformatics_Text_Data_2009+.csv", guess_max = 1000000)
...
write_csv(p2, "B1_Active_R01_Equivalent_Grants.csv")
```
